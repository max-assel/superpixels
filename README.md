...
1. Install the egocylindrical ROS2 package on the `ros2_humble` branch <a href="https://github.com/ivaROS/egocylindrical">here</a>.

2. Install the depth_img_normal_estimation ROS2 package on the `ros2_humble` branch <a href="https://github.com/max-assel/depth_img_normal_estimation">here</a>.
